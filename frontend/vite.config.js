  ...
  build: {
    rollupOptions: {
      input: {
        ...
        'booking-edit-locations': resolve(__dirname, 'booking-edit-locations.html'),
        'booking-passenger-info': resolve(__dirname, 'booking-passenger-info.html'),
        'booking-passenger-management': resolve(__dirname, 'booking-passenger-management.html'),
        'booking-payment': resolve(__dirname, 'booking-payment.html'),
        'booking-view-locations': resolve(__dirname, 'booking-view-locations.html'),
        'payment-link': resolve(__dirname, 'payment-link.html'),
